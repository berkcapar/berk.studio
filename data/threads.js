    ...
    turns: [
      {
        ...
        <p>If you'd like to get in touch — for a project, a collab, an opportunity or anything at all — email me at <a href="mailto:${EMAIL}">${EMAIL}</a>. Or send your message to the chat below and I'll reply real quick.</p>`,
      },
    ],
    chips: [
      {
    ...
    chips: [
      {
        ...
        a: `<p>Every one of them was a <strong>two-sided adoption problem</strong> wearing a different costume.</p>
            ...
            <p>The domain vocabulary changes. The question — <em>who has to say yes, and what would make that easy?</em> — doesn't.</p>`,
      },
      {
        ...
        a: `<p>That being early to a market is indistinguishable from being wrong, until you move.</p>
            <p>We built an AI SaaS product that generated strategy, content and campaign assets for businesses. Took it 0-to-1 with a hands-on team of 2 developers, 1 designer and 1 data engineer — discovery, prototyping, launch, customer validation, monetization. Exited in 2025 after validating demand and packaging the platform for acquisition.</p>
    ...
    turns: [
      {
        ...
        <div class="entries">
          <div class="entry">
            <div class="when">2025 &mdash;<br>now</div>
          ...
          <div class="entry">
            <div class="when">2023 &mdash;<br>2025</div>
            <div class="entry-body">
          ...
          <div class="entry">
            ...
            <div class="entry-body">
              ...
              <p class="blurb">Yara's all-in-one digital farming platform — agronomic tools, services and expert knowledge in one place.</p>
              <ul>
    ...
    turns: [
      {
        ...
        a: `
        <p class="lede">Product roles since 2016 — AdTech, mobile at carrier scale, developer platforms, agriculture, and now enterprise agentic AI.</p>
        <div class="entries">
          <div class="entry">
            <div class="when">09/2025 &mdash;<br>current</div>
            <div class="entry-body">
          ...
          <div class="entry">
            <div class="when">07/2023 &mdash;<br>10/2025</div>
            <div class="entry-body">
          ...
          <div class="entry">
            <div class="when">09/2023 &mdash;<br>05/2025</div>
            <div class="entry-body">
          ...
          <div class="entry">
            <div class="when">06/2022 &mdash;<br>08/2023</div>
            <div class="entry-body">
          ...
          <div class="entry">
            <div class="when">08/2021 &mdash;<br>04/2022</div>
            <div class="entry-body">
          ...
          <div class="entry">
            <div class="when">09/2017 &mdash;<br>08/2021</div>
            <div class="entry-body">
          ...
          <div class="entry">
            <div class="when">12/2016 &mdash;<br>09/2017</div>
            <div class="entry-body">
